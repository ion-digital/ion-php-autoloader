...
final class Autoloader extends Disposable implements AutoloaderInterface
{
     ...
     * 
     */
    public static function create(PackageInterface $package, array $developmentPaths, array $additionalPaths = null, AutoloaderSettings $settings = null, array $loaderClassNames = null) : AutoloaderInterface
    {
        return new static($package, $developmentPaths, $additionalPaths, $settings, $loaderClassNames);
    }
    /**
     * 
    ...
    protected function __construct(PackageInterface $package, array $sourcePaths, array $additionalPaths = null, AutoloaderSettings $settings = null, array $loaderClassNames = null)
    {
        ...
        if ($settings === null) {
            ...
            $settings = new AutoLoaderSettings($this->getPackage(), $enableCache, $enableDebug);
        }
