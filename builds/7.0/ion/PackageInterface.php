...
interface PackageInterface extends IPackage
{
     ...
     *
     */
    static function create(string $vendor, string $project, array $developmentPaths, array $additionalPaths = null, string $projectRoot = null, SemVerInterface $version = null, bool $enableDebug = null, bool $enableCache = null, array $loaderClassNames = null) : PackageInterface;
    /**
     *
     ...
     *
     */
    static function createSearchPath(PackageInterface $package, string $path);
    /**
     *
