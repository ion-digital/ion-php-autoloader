...
class AutoloaderSettings extends Disposable implements AutoloaderSettingsInterface
{
    ...
    public static function load(PackageInterface $package, string $filename = null) : AutoloaderSettingsInterface
    {
        ...
        return new AutoloaderSettings($package, isset($obj->cache) ? $obj->cache : false, isset($obj->debug) ? $obj->debug : false);
    }
    ...
    private $values = [];
    public function __construct(PackageInterface $package, bool $enableCache = true, bool $enableDebug = false)
    {
