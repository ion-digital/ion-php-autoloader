...
interface PackageInterface
{
     ...
     *
     */
    static function create($vendor, $project, array $developmentPaths, array $additionalPaths = null, $projectRoot = null, SemVerInterface $version = null, $enableDebug = null, $enableCache = null, array $loaderClassNames = null);
    /**
     *
     ...
     *
     */
    static function createSearchPath(PackageInterface $package, $path);
    /**
     *
     ...
     *
     */
    static function hasInstance($vendorName, $projectName);
    /**
     *
     ...
     *
     */
    static function getInstance($vendorName, $projectName);
    /**
     *
